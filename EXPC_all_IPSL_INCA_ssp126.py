...
#IPSL-INCA expc for historical+ssp126 and piControl, and their anomaly
...
#expc
file_ssp_expc=glob.glob(download_dir+'ssp126/'+data_expc+'_Omon_'+model_name+'_'+exp_ssp+'_'+real+'_'+grG+'_'+'*.nc')
...
nstart=240 # IPSL-INCA starts at 20 years after 1850, so 2400 months (timesteps) after the first file
nend1= time_all.size+nstart
# IPSL_LR 1850 is year 1870 
datch=-20
timeslices_pi=[element-datch for element in timeslices]

## Caclulate epxc control historical and ssp
...
nstart=0
nend3=data_ssp_expc.time.size-21*12
