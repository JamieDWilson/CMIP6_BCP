...
#MPI-ESM-HR Csoft for historical+ssp126 and piControl, and their anomaly
...
#oxygen
dir_o2 = data_dir+Scenario_ssp+'/'+ssp_centre+'/'+model_name+'/'+exp_ssp+'/'+real+'/Omon/'+data_o2+'/'+grG+'/latest/'
data_ssp_o2 = xr.open_mfdataset(dir_o2+'/*.nc')
#temperature
dir_T = data_dir+Scenario_ssp+'/'+ssp_centre+'/'+model_name+'/'+exp_ssp+'/'+real+'/Omon/'+data_T+'/'+grG+'/latest/'
data_ssp_T = xr.open_mfdataset(dir_T+'/*.nc')
#Salinity
dir_S = data_dir+Scenario_ssp+'/'+ssp_centre+'/'+model_name+'/'+exp_ssp+'/'+real+'/Omon/'+data_S+'/'+grG+'/latest/'
data_ssp_S = xr.open_mfdataset(dir_S+'/*.nc')
#Volcello - Volume
dir_V = data_dir+Scenario_ssp+'/'+ssp_centre+'/'+model_name+'/'+exp_ssp+'/'+real+'/Omon/'+data_V+'/'+grG+'/latest/'
file_V=glob.glob(dir_V+'/*.nc')
