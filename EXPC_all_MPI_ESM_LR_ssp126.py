...
#MPI-ESM-LR expc for historical+ssp126 and piControl, and their anomaly
...
Ar=xr.open_mfdataset('/badc/cmip6/data/CMIP6/CMIP/MPI-M/MPI-ESM1-2-LR/piControl/r1i1p1f1/Ofx/areacello/gn/latest/areacello_Ofx_MPI-ESM1-2-LR_piControl_r1i1p1f1_gn.nc')
