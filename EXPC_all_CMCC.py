...
#CMCC-ESM2 expc for historical+ssp370 and piControl, and their anomaly
...
#expc
file_ssp_expc=glob.glob(download_dir+'ssp370/'+data_expc+'_Oyr_'+model_name+'_'+exp_ssp+'_'+real+'_'+grG+'_'+'*.nc')
